...
#define HBAO_DEFERRED_INCLUDED
    ...
    CombinerOutput frag(v2f i) {
	    ...
	    o.gbuffer0 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_rt0Tex, uv);
	    o.gbuffer3 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_rt3Tex, uv);
#else
		o.gbuffer0 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_rt0Tex, i.uv2);
		o.gbuffer3 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_rt3Tex, i.uv2);
#endif
	    o.gbuffer0.a *= occ.a;
